...
class COINMScreen extends ConsumerStatefulWidget {
  final Function(int)? onTabChanged; // Optional callback

  const COINMScreen({super.key, this.onTabChanged});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _COINMScreenState();
}

class _COINMScreenState extends ConsumerState<COINMScreen>
    with SingleTickerProviderStateMixin {
  List<Map<String, dynamic>> positionsList = [];

  // late TabController _tabController;
  String currentSymbol = "UNIUSD";
  ...
  Widget build(BuildContext context) {
    ...
    String cutStringToLength(String text, int maxLength) {
                        ...
                        Row(
                          children: [
                            CustomText(
                              ...
                              text: cutStringToLength("UNIUSD CM", 6),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        child: TextFormField(
                                      controller:
                                          TextEditingController(text: "${valueSlider}%"),
                                    ))
                                    // Expanded(
                                    //   child: TextField(
                                    //     controller: _marginLeverageController,
